...
Ainsi, beaucoup de joueurs vont utiliser des "overlay", ce sont des logiciels tiers, qui vont modifier les données du jeu pour changer l'affichage du jeu, et ajouter des informations qui peuvent être utile au joueur.

Contrairement aux jeux FPS où les visualisations sont majoritairement faites par des professionels, qu'ils soient destinés à être intégrés au jeu, à être vus par des spectateurs ou à aider les joueurs à progresser, dans les MMORPG, ce sont des joueurs passionnés qui créent la plupart des overlay pour améliorer l'expérience de jeu des autres joueurs.
